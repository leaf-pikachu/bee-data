/**
 @name: layui-o 2.x TypeScript 类型定义.
 @author: 巽翎君.
 */
...
declare namespace Layui {
    ...
    export interface LayuiInstance {
        ...
        define(factory: (exports: Function) => any): any;
        /** 使用特定模块.
         * @param apps 要使用的模块名称.
         * @param callback 回调函数.
         * @param exports layui-o 作者未对此参数进行说明! */
         ...
         * @param fn layui-o 作者未对此参数进行说明!
         * @param cssname layui-o 作者未对此参数进行说明! */
