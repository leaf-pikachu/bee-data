/**
 @name: layui-o.element 常用元素操作 TypeScript 类型定义.
 @author: 巽翎君.
 */

declare namespace Layui {
    /** layui-o.element 组件接口声明. */
    export interface IElementStatic {
        ...
        /** 用于绑定自定义 Tab 元素(即非 layui-o 自带的 tab 结构)，该方法为 layui-o 2.1.6 新增！
         * @param options 设定可选值的对象. */
        ...
        /** 功能与 init 方法相同，此为 layui-o 2.1.6 版本新增方法. */
